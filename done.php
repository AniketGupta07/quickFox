...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
    	// echo "here";
        $sql2 = " SELECT lat,lon FROM data WHERE( item regexp '".$row["itm"]."')";
...
<html>
<head>
	<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDkqGlGRIOABg_apXOkVHli_1Qkd-kNFes"></script>
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
<script type="javascript">
	// var x = document.getElementById("res").value;
	// document.write(window.route);

	document.getElementById("res2").innerHTML="HELLO";
</script>
...
var shoplat = <?php echo json_encode($shoplat); ?>;
	...
	function initializeMap() {
        ...
        for (var i = shoplat.length- 1; i >= 0; i--) {
...
function getDurations(callback) {
    ...
    service.getDistanceMatrix({
        ...
        avoidHighways: parseInt(true) > 0 ? true : false,
        avoidTolls: false,
    ...
    $('#find-route').click(function() {    
        ...
        getDurations(function(){
            ...
            ga.evolvePopulation(pop, function(update) {
                ...
                // document.getElementById("res").innerHTML=route;
...
var ga = {
    ...
    "getConfig": function() {
        ga.crossoverRate = parseFloat(0.5);
        ga.mutationRate = parseFloat(0.1);
        ga.populationSize = parseInt(50);
        ga.elitism = parseInt(true);
        ga.maxGenerations = parseInt(50);
    },
