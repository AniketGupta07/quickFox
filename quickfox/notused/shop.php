									...
									<nav id="mobile-menu-active">
										<ul id="nav">
											...
											<li><a href="groceries1.php">Shop</a>
												<ul>
													<li><a href="groceries1.php">Bakeries</a></li>
													<li><a href="groceries1.php">Groceries</a></li>
													<li><a href="groceries1.php">Stationeries</a></li>
													<li><a href="groceries1.php">Homecare</a></li>
													<li><a href="groceries1.php">Personal Care</a></li>
													<li><a href="groceries1.php">Fruits and Veggies </a></li>
