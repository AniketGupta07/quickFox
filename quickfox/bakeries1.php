                                ...
                                <div class="menu-area">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a  style="color: red;" href="bakeries1.php">Shop</a>
                                                <ul class="mega-menu">
                                                    <li><a href="#">Categories</a>
                                                     <ul class="mega-menu mega-menu-2">
                                                    <li>
                                                        <ul class="sub-menu-2">
                                                            <li><a  style="color: red;" href="bakeries1.php">Bakeries</a></li>
                                ...
                                <div class="mobile-menu">
                                    <nav id="mobile-menu-active">
                                        <ul id="nav">
                                            ...
                                            <li><a href="bakeries1.php" style="color: red;">Shop</a>
                                                <ul>
									...
									<nav id="mobile-menu-active">
										<ul id="nav">
											...
											<li><a href="groceries1.php">Shop</a>
												<ul>
													<li style="color: red;"><a href="#">Bakeries</a></li>
													<li><a href="groceries1.php">Groceries</a></li>
													<li><a href="stationeries1.php">Stationeries</a></li>
													<li><a href="homecare1.php">Homecare</a></li>
													<li><a href="personalcare1.php">Personal Care</a></li>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="breadcrumb-content text-center">
								...
								<ul>
									<li><a href="#">Home /</a></li>
									<li style="color: red;"><a href="#">Shop</a></li>
								</ul>
							</div>
						</div>
					</div>
								...
								<div class="shop-tab">
									...
									<div class="tab-menu-3">
										<ul>
											...
											<li style="color: red;"><a href="#list"  data-toggle="tab"><img src="img/th.jpg">></a></li>
										</ul>
									</div>
									<!-- tab-menu-end -->
												...
												<div class="product-wrapper mb-40">
													...
													<div class="product-content pt-20">
														<div class="manufacture-product">
															<div class="rating">
																<ul>
																	<li><a href="#"><i class="fa fa-star"></i></amymodal></li>
																	<li><a href="#"><i style="color: #FFD700;" class="fa fa-star"></i></a></li>
																	<li><a href="#"><i style="color: #FFD700;" class="fa fa-star"></i></a></li>
																	<li><a href="#"><i style="color: #FFD700;" class="fa fa-star"></i></a></li>
																	<li><a href="#"><i style="color: #FFD700;" class="fa fa-star"></i></a></li>
								...
								<div class="pagination-area">
									<div class="pagination-number">
										<ul>
											...
											<li style="color: red;"><a href="#">1</a></li>
